...
namespace HS2_BetterHScenes
{
    ...
    public class MotionOffsetsXML
    {
        ...
        {
            LeftHandJointCorrection = HS2_BetterHScenes.defaultJointCorrection.Value;
            RightHandJointCorrection = HS2_BetterHScenes.defaultJointCorrection.Value;
            LeftFootJointCorrection = HS2_BetterHScenes.defaultJointCorrection.Value;
            RightFootJointCorrection = HS2_BetterHScenes.defaultJointCorrection.Value;
        }
